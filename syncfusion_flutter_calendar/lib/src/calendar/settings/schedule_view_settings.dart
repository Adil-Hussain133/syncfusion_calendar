...
class MonthHeaderSettings with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    return otherStyle.monthFormat == monthFormat &&
        ...
        otherStyle.backgroundImageUrl == backgroundImageUrl &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('backgroundImageUrl', backgroundImageUrl));
  ...
  int get hashCode {
    return Object.hash(
        monthFormat, height, textAlign, backgroundColor, backgroundImageUrl, monthTextStyle);
  }
}
